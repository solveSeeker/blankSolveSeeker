# 🚀 Sistema de Gestión de Pedidos Multi-Tenant

Aplicación web white-label de gestión de pedidos con Next.js 16 + Supabase + Claude Code. Arquitectura multi-tenant Feature-First optimizada para desarrollo asistido por IA.

## 📌 Estado del Proyecto

**FASE 1 COMPLETADA** ✅ - Setup + Auth + Multi-tenancy

- ✅ Next.js 15.0.3 con App Router + TypeScript
- ✅ Supabase (Database + Auth + RLS)
- ✅ Tailwind CSS configurado
- ✅ Sistema de autenticación completo
- ✅ Multi-tenancy con theming dinámico
- ✅ Middleware de detección de tenant
- ✅ Sistema de roles base (Admin, Vendedor, Supervisor)

📖 **Ver detalles**: [FASE1-COMPLETADA.md](FASE1-COMPLETADA.md)
🚀 **Empezar**: [INSTRUCCIONES-SETUP.md](INSTRUCCIONES-SETUP.md)

## 🎯 ¿Qué es esto?

Un sistema **production-ready** de gestión de pedidos multi-tenant que permite:

- ✅ **White-Label**: Cada cliente tiene su branding (logo, colores, favicon)
- ✅ **Multi-Empresa**: Un cliente puede gestionar múltiples empresas
- ✅ **Multi-Usuario**: Control de acceso granular por empresa y rol
- ✅ **Pedidos**: Sistema completo de gestión de órdenes con PDF
- ✅ **Catálogo**: Gestión de productos y clientes compartidos
